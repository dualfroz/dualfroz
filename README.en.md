...
<img src="https://github.com/dualfroz.png" width="112" alt="Michał DualFroz Fox, software developer from Kraków">

# Michał "DualFroz" Fox

**Software developer building games and IT ecosystems, based in Kraków, Poland**

Founder of [VulCode](https://vulcode.com) · co-founder of [Aphrodi](https://aphrodi.pl) and Lunatic Studios · lead developer of Spectra and Plazer

[![dualfroz.com](https://img.shields.io/badge/dualfroz.com-7aa2f7?style=flat-square&logo=googlechrome&logoColor=white)](https://dualfroz.com)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0a66c2?style=flat-square&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/dualfroz/)
[![X](https://img.shields.io/badge/X-000000?style=flat-square&logo=x&logoColor=white)](https://x.com/dualfroz)
[![Instagram](https://img.shields.io/badge/Instagram-e4405f?style=flat-square&logo=instagram&logoColor=white)](https://www.instagram.com/dualfroz/)
[![Discord](https://img.shields.io/badge/Discord-5865f2?style=flat-square&logo=discord&logoColor=white)](https://discord.com/users/181326503601111041)
[![Email](https://img.shields.io/badge/me@dualfroz.com-2f3549?style=flat-square&logo=maildotru&logoColor=white)](mailto:me@dualfroz.com)

<sub>[Polski](README.md) · **English**</sub>

</div>

<br>

I like putting real work into open source, exploring new technologies and going down to the lowest level just to see how something works. I started in 2020 with web development and game servers. Today I build complex software, SaaS products and custom systems for clients.

> **Now:** I've recently been working on finishing the first version of Flaem, a hosting panel. The project is written in several languages (TypeScript, Rust, Elixir, Golang, plus microservices in Java, Python and C) and adds up to almost a million lines of code. I'm planning the first release of Flaem for around October/November 2026.
...
- 🌐 Website: [dualfroz.com](https://dualfroz.com)
- ✉️ Email: [me@dualfroz.com](mailto:me@dualfroz.com)
...
- 🏢 Company: [vulcode.com](https://vulcode.com)

</td>
    <td valign="top" align="center">
      <a href="https://discord.com/users/181326503601111041"><img src="https://ghapi.dualfroz.com/discord" width="380" alt="My live Discord profile: status and activity"></a>
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="64" align="center"><img src="https://raw.githubusercontent.com/dualfroz/dualfroz/main/assets/projects/vulcode.png" width="40" alt="VulCode logo"></td>
    <td><b><a href="https://vulcode.com">VulCode</a></b> &nbsp;<code>founder</code><br>A Polish software house: websites, panels and dashboards, applications and scalable platforms. More than 3 million lines of code since 2020.</td>
  </tr>
  <tr>
    <td align="center"><img src="https://raw.githubusercontent.com/dualfroz/dualfroz/main/assets/projects/aphrodi.webp" width="40" alt="Aphrodi logo"></td>
    <td><b><a href="https://aphrodi.pl">Aphrodi</a></b> &nbsp;<code>co-founder</code><br>A creative agency: branding, visual identity, web design, 3D graphics and video.</td>
  </tr>
  <tr>
    <td align="center"><img src="https://raw.githubusercontent.com/dualfroz/dualfroz/main/assets/projects/lunatic.png" width="40" alt="Lunatic Studios logo"></td>
    <td><b>Lunatic Studios</b> &nbsp;<code>co-founder</code><br>An independent game studio: online chess with custom rules and a set of mini games.</td>
  </tr>
  <tr>
    <td align="center"><img src="https://cdn.discordapp.com/emojis/1534902970246762649.webp?size=64&quality=lossless" width="40" alt="Spectra"></td>
    <td><b>Spectra</b> &nbsp;<code>lead developer</code> <code>beta</code><br>A hosting platform: game servers and containers, VPS and LXC, network services, anti-DDoS and IPMI. Seven modules in Rust, Elixir and Go.</td>
  </tr>
  <tr>
    <td align="center">💬</td>
    <td><b>Plazer</b> &nbsp;<code>lead developer</code> <code>in development</code><br>An end-to-end encrypted messenger: private, lightweight, customizable and self-hostable.</td>
  </tr>
  <tr>
    <td align="center">🤖</td>
    <td><b>Gyred</b> &nbsp;<code>author</code> <code>in development</code><br>A panel for long autonomous AI agent sessions with long-term memory kept in indexed files.</td>
  </tr>
</table>
...
- **Vulp**: a Rust terminal app for managing a workspace of repositories (repo state, sync, pull requests, statistics)
- **Atrium** and **Lokal**: panels for hotels and restaurants with an interactive floor plan
- **VulBio**: personal pages assembled from a panel, no code
- **Nebula**: plugins for SCP: Secret Laboratory, including server moderation and analytics
...
<p align="center">
  <img src="https://ghapi.dualfroz.com/v2/public/cards/heatmap.svg?lang=en" width="100%" alt="Commit heatmap for the last year">
</p>
...
**Frameworks & tools detected across projects** <sub>(repository count)</sub>
...
<sub>Counted by my own API [ghapi.dualfroz.com](https://ghapi.dualfroz.com/v2/public) across every repository, private ones included. Updated daily.</sub>


## 🌍 Open source

Code that made it into projects I use every day. **40** merged pull requests in **39** repositories with **250,000+** stars combined.

| Project | Stars | Language | Changes |
|---|---|---|---|
| [icsharpcode/ILSpy](https://github.com/icsharpcode/ILSpy) | ⭐ 26.1k | C# | <code>+4475</code> <code>-9</code> |
...
| [spencermountain/compromise](https://github.com/spencermountain/compromise) | ⭐ 12.2k | JavaScript | <code>+49</code> <code>-3</code> |
...
| [itchyny/gojq](https://github.com/itchyny/gojq) | ⭐ 3.8k | Go | <code>+42</code> <code>-5</code> |
| [Suor/funcy](https://github.com/Suor/funcy) | ⭐ 3.5k | Python | <code>+18</code> <code>-2</code> |
...
<p>
  <img src="https://skillicons.dev/icons?i=ts,rust,php,go,kotlin,cs,py,cpp,swift,zig,elixir&perline=11" alt="TypeScript, Rust, PHP, Go, Kotlin, C#, Python, C++, Swift, Zig, Elixir">
</p>

**Frontend:** React, Next.js, Vite, Tailwind CSS · **Backend:** Node.js (Express, NestJS), Rust (Axum, Tokio), Go, PHP (Laravel) · **Data:** PostgreSQL, MySQL, SQLite, Redis · **Infrastructure:** Linux, Docker, nginx · **Also:** game plugins, Discord bots, CLI tools

## ♟️ Beyond code

Chess (2000+ on chess.com, aiming for a FIDE rating), linguistics, history and culture.

<br>

<div align="center">
<sub>Commercial work: <a href="https://vulcode.com">vulcode.com</a> · Everything else: <a href="mailto:me@dualfroz.com">me@dualfroz.com</a></sub>
</div>